...
export const metadata: Metadata = {
  ...
  description: 'Wholesale distribution, logistics, and government contracting from Miami, FL. Authorized dealer for Glenair, WellAir, and 20+ brands. SAM.gov registered.',
