const BRAND_STYLES: Record<string, string> = {
  ...
  "Elation · ADJ · Global Truss": "font-barlow-condensed font-bold tracking-[0.05em] uppercase",
  ...
  "Global Truss": "font-barlow-condensed font-bold tracking-[0.05em] uppercase",
