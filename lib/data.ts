...
export const FLAGSHIP_BRANDS: FlagshipBrand[] = [
  ...
  },
  {
    ...
    description_en: "Professional stage and event lighting fixtures, moving heads, controllers, and intelligent lighting for touring, installations, clubs, and houses of worship.",
    description_es: "Fixtures de iluminación profesional para escenario y eventos, cabezales móviles, controladores e iluminación inteligente para giras, instalaciones, clubes e iglesias.",
    tags: ["Moving Heads", "Controllers", "Fixtures", "Intelligent Lighting"],
    color: "#D4145A",
    url: "https://www.adj.com/",
  },
  {
    name: "Wet Sounds",
    tier: "Authorized Dealer",
...
export const CATEGORIES: Category[] = [
  ...
  { key: "lighting", name_en: "Professional Lighting & Stage", name_es: "Iluminación Pro & Escenario", brands: ["American DJ"] },
