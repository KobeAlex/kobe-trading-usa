...
export const FLAGSHIP_BRANDS: FlagshipBrand[] = [
  ...
  {
    name: "Elation · ADJ · Global Truss",
    tier: "Authorized Dealer",
    category: "Pro Lighting & Stage",
    founded: "1985",
    origin: "USA / Global",
    certs: ["ETL Listed", "DMX-512"],
    description_en: "Complete stage lighting ecosystem. Elation moving heads and controllers, American DJ fixtures, and Global Truss aluminum structures for touring, installs, and houses of worship.",
    description_es: "Ecosistema completo de iluminación escénica. Cabezales móviles y controladores Elation, fixtures American DJ y estructuras de aluminio Global Truss para giras, instalaciones e iglesias.",
    tags: ["Moving Heads", "Controllers", "Truss", "Intelligent Lighting"],
    color: "#D4145A",
    url: "https://www.elationlighting.com/",
  },
  {
    name: "Wet Sounds",
    tier: "Authorized Dealer",
...
export const CATEGORIES: Category[] = [
  ...
  { key: "lighting", name_en: "Professional Lighting & Stage", name_es: "Iluminación Pro & Escenario", brands: ["Elation", "American DJ", "Global Truss"] },
...
export const BRAND_URLS: Record<string, string> = {
  ...
  "Global Truss": "https://globaltruss.com/",
